...
public class EmployeeProfile_Admin extends javax.swing.JFrame {

    private final String csvFile = "MotorPHEmployeeData.csv";

    public EmployeeProfile_Admin() throws FileNotFoundException, IOException {
        initComponents();
    ...
    private void initComponents() {
        ...
        getContentPane().add(jButtonProfileUpdate, new org.netbeans.lib.awtextra.AbsoluteConstraints(880, 560, 150, 20));
    ...
    private void jButtonAttendanceActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonAttendanceActionPerformed
        ...
        try {
            AttendanceAdmin viewAttendance = new AttendanceAdmin();
            // Display the window
            viewAttendance.setVisible(true);
            viewAttendance.pack();
            viewAttendance.setDefaultCloseOperation(PayrollProcessing.DISPOSE_ON_CLOSE); //if viewEmployeeFrame is close, main frame will not close.
            ...
            viewAttendance.jTextFieldEmployeeNum.setText(model.getValueAt(selectedRowIndex, 0).toString());
            viewAttendance.jTextFieldName.setText(fullName);
    ...
    private void jButtonUpdateDBSActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonUpdateDBSActionPerformed
        ...
        if (response == JOptionPane.YES_OPTION) {
            Filehandling filehandler = new Filehandling(csvFile);
            filehandler.exportTableToCSV(jTableEmployeeList);
        }
